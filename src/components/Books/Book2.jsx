  ...
  <div>
      ...
      <Container fluid className="p-4">
        <Row className=" seven g-4">
          ...
          {/* Content Column */}
          <Col xs={12} md={6} className="d-flex flex-column align-items-center align-items-md-start text-center text-md-start education-text text- px-md-4 px-3">
            ...
            <Button className=" align-self-md-start align-self-center mt-3" variant="dark">Purchase</Button>
          </Col>
        </Row>
      </Container>
